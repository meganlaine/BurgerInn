...
public class Reservation
{
    ...
    public Reservation( Room r, Guest g, Status status, int partySize, int nights)
    {
        ...
        {       
            setPaymentDue();
        } else if (this.status == Status.OUT) {
            setPaymentDue();
            payBill();
        }
    ...
    public void setStatus( Status s )
    {
        ...
        // if a valid request, free up the room & assume that entire payment will be collected.
        if ( s == Status.OUT ) 
        {
            if (this.getStatus() == Status.CANCELED)
            {
    ...
    public String payBill() 
    {
        ...
        return ("Thank you for checking out of BURGER INN." + "\n" +
            "Your payment was successful. Remaining balance: " + this.paymentDue);
    }
    ...
    public String toString()
    {
        ...
        "Room: " + r.getRoomNumber() + ", Floor: " + r.getFloor() +
            ", BedType: " + r.getBedType() + ", Capacity: " + r.getCapacity() + '\n' +
